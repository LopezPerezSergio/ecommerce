...
function quantity_added($product_id, $color_id = null, $size_id = null)
{
    $cart = Cart::content();
...
function quantity_available($product_id, $color_id = null, $size_id = null){
    return quantity($product_id, $color_id, $size_id) - quantity_added($product_id, $color_id, $size_id);
}